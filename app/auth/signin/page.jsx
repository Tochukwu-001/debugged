...
const page = async () => {
    ...
    console.log(session)
    return (
        <main className='min-h-100vh flex items-center justify-center lg:p-10'>
            <section className='shadow-md rounded-md p-5 w-1/2 mx-auto space-y-10 lg:space-y-20'>
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    >
                        <button type='submit' className='border border-gray-200 flex items-center justify-center gap-2 px-2 py-3 rounded-full'>
                    ...
                    <button className='border border-gray-200 flex items-center justify-center gap-2 px-2 py-3 rounded-full'>
                        ...
                        <p className='text-gray-700'>Contine with Twitter</p>
                    </button>
